...
class TestFindClosestRate:
    ...
    def test_find_closest_rate_currency_not_found(self):
        ...
        rates = {"USD": {date(2024, 1, 15): Decimal("0.86")}}
...
class TestConvertAmountToDomestic:
    ...
    def test_convert_cross_currency(self):
        ...
        rates = {
            "USD": {date(2024, 1, 15): Decimal("0.85")},  # 1 USD = 0.85 EUR
            "GBP": {date(2024, 1, 15): Decimal("0.75")},  # 1 GBP = 0.75 EUR
        }
...
class TestRecalculateTransactionsDomesticAmount:
    ...
    def test_recalculate_same_currency(
        self, expense_transaction, test_workspace, workspace_settings
    ):
    ...
    def test_recalculate_different_currency_no_rates(
        self, test_workspace, workspace_settings, test_user, expense_root_category
    ):
    ...
    def test_recalculate_with_exchange_rates(
        self,
        test_workspace,
        workspace_settings,
        test_user,
    ...
    def test_recalculate_mixed_currencies(
        self,
        test_workspace,
        workspace_settings,
        test_user,
        ...
        from finance.models import ExchangeRate, Transaction
    ...
    def test_recalculate_transactions_with_valid_dates(
        self,
        test_workspace,
        workspace_settings,
        test_user,
...
class TestIntegrationScenarios:
    ...
    def test_complete_currency_conversion_flow(
        self, test_workspace, workspace_settings, test_user, expense_root_category
    ):
        ...
        assert usd_transaction.amount_domestic == Decimal(
            "170.0000"
        )  # 200 USD → 170 EUR
