...
DATABASES['default']['HOST'] = config('DB_HOST_PROD')
DATABASES['default']['NAME'] = config('POSTGRES_DB_PROD', default=config('POSTGRES_DB'))

# Logging (production - structured and monitored)
